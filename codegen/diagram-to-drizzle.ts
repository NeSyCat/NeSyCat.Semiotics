 ...
 * convention documented in codegen/README.md) and emit a Drizzle schema.ts.
 *
 * Usage: tsx codegen/diagram-to-drizzle.ts <input.json> <output.ts>
 *
...
function main(): void {
  ...
  if (!inPath || !outPath) die('usage: tsx codegen/diagram-to-drizzle.ts <input.json> <output.ts>')
  ...
  parts.push(
    `// DO NOT EDIT — generated by codegen/diagram-to-drizzle.ts from ${relIn}.`,
